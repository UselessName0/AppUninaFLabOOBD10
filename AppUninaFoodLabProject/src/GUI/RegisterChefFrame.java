...
public class RegisterChefFrame extends JFrame {
    ...
    public RegisterChefFrame() {
        ...
        JButton registerButton = createStyledButton("Registrati", new Color(46, 139, 87));
        registerButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (email.trim().isEmpty() || pwd.trim().isEmpty()) {
                    JOptionPane.showMessageDialog(RegisterChefFrame.this, "Compila tutti i campi.");
                    return;
                }
    ...
    // Sfondo gradiente coerente con gli altri frame
    private class GradientPanel extends JPanel {
        protected void paintComponent(Graphics g) {
            ...
            int w = getWidth();
            int h = getHeight();
            Color color1 = new Color(173, 216, 255); // Azzurro brillante
